...
```python
bong = Director.objects.get(name='봉준호').id
for i in Movie.objects.filter(director_id=bong).order_by('opening_date'):
  print(i.director.name, i.genre.title, i.title, i.opening_date, i.running_time, i.screening)
```
...
```python
bong = Director.objects.get(name='봉준호').id
i = Movie.objects.filter(director_id=bong).order_by('opening_date')[1]
print(i.director.name, i.genre.title, i.title, i.opening_date, i.running_time, i.screening)
```
...
```python
import datetime
for i in Movie.objects.filter(opening_date__gte=datetime.date(2022, 1, 1)).order_by('opening_date'):
  print(i.director.name, i.genre.title, i.title, i.opening_date, i.running_time, i.screening)
```
...
```python
bong = Director.objects.get(name='봉준호').id
drama = Genre.objects.get(title='드라마').id

for i in Movie.objects.filter(director_id=bong, genre_id=drama).order_by('opening_date'):
  print(i.director.name, i.genre.title, i.title, i.opening_date, i.running_time, i.screening)
```
...
for i in Movie.objects.exclude(director_id=bong).order_by('opening_date'):
  print(i.director.name, i.genre.title, i.title, i.opening_date, i.running_time, i.screening)
```